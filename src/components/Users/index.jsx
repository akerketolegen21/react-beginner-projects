      ...
      {isLoading ? (
        ...
        <ul className="users-list">
           {items.filter(obj => {
            ...
            return (fullName.includes(searchValue) || obj.email.toLowerCase().includes(searchValue));
          }).map((object) => (
              <User isInvited={invites.includes(object.id)} onClickInvite={onClickInvite} key={object.id} user = {object}/>
          ))}
